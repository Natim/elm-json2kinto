...
var _Natim$elm_json2xls$Json2Xls$buildXls = _elm_lang$core$Native_Platform.outgoingPort(
	'buildXls',
	function (v) {
		return v;
	});
var _Natim$elm_json2xls$Json2Xls$xlsBuilt = _elm_lang$core$Native_Platform.incomingPort('xlsBuilt', _elm_lang$core$Json_Decode$string);
var _Natim$elm_json2xls$Json2Xls$builtSub = function (builtMsg) {
	return _Natim$elm_json2xls$Json2Xls$xlsBuilt(builtMsg);
};
...
var _Natim$elm_json2xls$Main$encodeRecord = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'content',
					_1: _elm_lang$core$Json_Encode$string(record.content)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _Natim$elm_json2xls$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Download') {
			var data = _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _Natim$elm_json2xls$Main$encodeRecord, model.records));
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _Natim$elm_json2xls$Json2Xls$buildXls(data)
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						xls: _elm_lang$core$Maybe$Just(_p0._0)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _Natim$elm_json2xls$Main$init = {
	ctor: '_Tuple2',
	_0: {
		records: {
			ctor: '::',
			_0: {title: 'Bonjour', content: 'les amis'},
			_1: {
				ctor: '::',
				_0: {title: 'Bonsoir', content: 'Mariane'},
				_1: {ctor: '[]'}
			}
		},
		xls: _elm_lang$core$Maybe$Nothing
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _Natim$elm_json2xls$Main$Model = F2(
	function (a, b) {
		return {records: a, xls: b};
	});
var _Natim$elm_json2xls$Main$Record = F2(
	function (a, b) {
		return {title: a, content: b};
	});
var _Natim$elm_json2xls$Main$XlsBuilt = function (a) {
	return {ctor: 'XlsBuilt', _0: a};
};
var _Natim$elm_json2xls$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _Natim$elm_json2xls$Json2Xls$builtSub(_Natim$elm_json2xls$Main$XlsBuilt),
			_1: {ctor: '[]'}
		});
};
var _Natim$elm_json2xls$Main$Download = {ctor: 'Download'};
var _Natim$elm_json2xls$Main$view = function (model) {
	var file = function () {
		var _p1 = model.xls;
		if (_p1.ctor === 'Nothing') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_Natim$elm_json2xls$Main$Download),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Prepare XLS file'),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'download', 'file.xls'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(
							A2(_elm_lang$core$Basics_ops['++'], 'data:application/vnd.ms-excel;base64,', _p1._0)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Download XLS file'),
					_1: {ctor: '[]'}
				});
		}
	}();
...
var _Natim$elm_json2xls$Main$main = _elm_lang$html$Html$program(
	{init: _Natim$elm_json2xls$Main$init, view: _Natim$elm_json2xls$Main$view, update: _Natim$elm_json2xls$Main$update, subscriptions: _Natim$elm_json2xls$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Natim$elm_json2xls$Main$main !== 'undefined') {
    _Natim$elm_json2xls$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"XlsBuilt":["Main.Base64"],"Download":[]}}},"aliases":{"Main.Base64":{"args":[],"type":"String"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
